...
class AuditLog(models.Model):
    ...
    class Action(models.TextChoices):
        ...
        LOGIN_2FA_FAILED       = "login_2fa_failed",       "Login 2FA Failed"
        LOGOUT                 = "logout",                 "Logout"
        REGISTER               = "register",               "Register"
        EMAIL_VERIFY_SENT      = "email_verify_sent",      "Email Verification Sent"
        EMAIL_VERIFIED         = "email_verified",         "Email Verified"
        EMAIL_VERIFY_FAILED    = "email_verify_failed",    "Email Verification Failed"
        PASSWORD_RESET_REQUEST = "password_reset_request", "Password Reset Requested"
        PASSWORD_RESET_DONE    = "password_reset_done",    "Password Reset Completed"
